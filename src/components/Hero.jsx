export default function Hero({ link }) {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 sm:px-6 py-20 bg-white overflow-hidden">
      {/* Decorative blobs */}
      <div
        className="absolute top-10 left-0 w-48 sm:w-72 h-48 sm:h-72 rounded-full opacity-20 blur-3xl pointer-events-none"
        style={{ background: 'radial-gradient(circle, #3b82f6, transparent)' }}
      />
      <div
        className="absolute bottom-10 right-0 w-64 sm:w-96 h-64 sm:h-96 rounded-full opacity-20 blur-3xl pointer-events-none"
      ...
      <p className="text-gray-600 text-base sm:text-xl md:text-2xl max-w-2xl mb-10 px-2">
        ...
        <strong className="text-gray-900">195+ Video Lessons</strong>, 37
        Chapters &{' '}
      ...
      <p className="text-gray-500 text-xs sm:text-sm">
        🔒 Secure Payment &nbsp;•&nbsp; Instant Access &nbsp;•&nbsp; Lifetime
        Validity
      </p>

    ...
    <section className="py-14 sm:py-16 px-4 sm:px-6 text-center bg-gradient-to-r from-red-50 to-orange-50">
      ...
      <div className="flex justify-center gap-3 sm:gap-4 mb-6">
        {[
          ...
          <div
            key={i}
            className="glass rounded-2xl px-4 sm:px-6 py-3 sm:py-4 min-w-[70px] sm:min-w-[90px]"
            style={{ border: '2px solid rgba(239,68,68,0.3)' }}
          >
            <div className="text-3xl sm:text-5xl font-black text-red-500">
              {t.val}
            </div>

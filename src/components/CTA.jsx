export default function CTA({ link }) {
  return (
    <section id="buy" className="py-16 sm:py-24 px-4 sm:px-6 text-center relative overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      <div className="relative z-10 max-w-2xl mx-auto">
        ...
        <div className="glass rounded-2xl p-6 sm:p-10 mb-8 shadow-2xl">
          <p className="text-gray-500 text-sm mb-2">
            Original Value:{' '}
            <span className="line-through font-bold text-xl text-gray-700">₹9,000</span>
          </p>

          <div className="my-4">
            <span className="text-5xl sm:text-7xl font-black text-gray-900">₹149</span>
            <span className="text-green-600 font-bold text-lg block mt-1">Only Today! 🎉</span>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-2 text-xs sm:text-sm text-gray-600 mb-6">
            ...
            <span className="glass px-3 py-1 rounded-full">✅ Lifetime Access</span>
          </div>
          ...
          <a href={link} target="_blank" rel="noopener noreferrer"
            ...
            👉 Buy Now ₹149 & Get All Bonuses FREE
          </a>
